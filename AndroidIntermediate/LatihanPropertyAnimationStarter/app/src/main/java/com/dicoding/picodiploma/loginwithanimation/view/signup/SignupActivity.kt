...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val namePlaceholder = ObjectAnimator.ofFloat(binding.nameTextView, View.ALPHA, 1F).apply {
            duration = 500
        }
        val nameEditTextLayout =
            ObjectAnimator.ofFloat(binding.nameEditTextLayout, View.ALPHA, 1F).apply {
                duration = 500
            }
        ...
        val signupButton = ObjectAnimator.ofFloat(binding.signupButton, View.ALPHA, 1F).apply {
            duration = 500
        }
        AnimatorSet().apply {
            playSequentially(
