...
import dev.cisnux.likesapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Di sini, kita menggunakan drawArc untuk membangun lingkaran dengan sudut tertentu. Jadi, kita bisa menggunakannya untuk membangun 2 buah object setengah lingkaran yang berfungsi untuk menggambar wajah dengan warna yang berbeda. Object pertama dimulai dari sudut 90 derajat (90F), sedangkan object selanjutnya dimulai dari sudut 270 derajat (270F).
     * */
    ...
    private fun showEyes() {
        ...
        mPaint.color = ResourcesCompat.getColor(resources, R.color.white, null)
        mCanvas.drawCircle(halfOfWidth - 120F, halfOfWidth - 20F, 15F, mPaint)
        mCanvas.drawCircle(halfOfWidth + 80F, halfOfWidth - 20F, 15F, mPaint)
    }
