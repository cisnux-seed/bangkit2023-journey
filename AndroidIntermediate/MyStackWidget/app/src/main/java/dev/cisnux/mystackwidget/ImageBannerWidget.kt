...
class ImageBannerWidget : AppWidgetProvider() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == TOAST_ACTION) {
            ...
            Toast
                .makeText(context, "Touched view $viewIndex", Toast.LENGTH_SHORT)
                .show()
        }
    }
    ...
    companion object {
        private const val TOAST_ACTION = "dev.cisnux.MyStackWidget.TOAST_ACTION"
        const val EXTRA_ITEM = "dev.cisnux.MyStackWidget.EXTRA_ITEM"
