...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.course.observe(this, ::showCourseDetail)
    }
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val tvCourseName: TextView = findViewById(R.id.tv_course_name)
            val tvTime: TextView = findViewById(R.id.tv_time)
            val tvLecturer: TextView = findViewById(R.id.tv_lecturer)
