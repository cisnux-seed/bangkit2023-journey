...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /**
         * Kemudian terdapat operator skipInitialValue()
         * untuk menghiraukan input awal.
         * Hal ini bertujuan supaya aplikasi
         * tidak langsung menampilkan eror pada
         * saat pertama kali dijalankan. Anda dapat
         * menghapus kode ini untuk melihat perbedaanya.
         * */
