...
import dev.cisnux.myalarmmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.btn_once_date -> {
                // show fragment date picker
                val datePickerFragment = DatePickerFragment(::onDialogDateSet)
                datePickerFragment.show(supportFragmentManager, DATE_PICKER_TAG)
            }
            R.id.btn_once_time -> {
                val timePickerFragmentOne = TimePickerFragment(::onDialogTimeSet)
            ...
            R.id.btn_repeating_time -> {
                // show fragment time picker
                val timePickerFragmentRepeat = TimePickerFragment(::onDialogTimeSet)
    ...
    private fun onDialogTimeSet(tag: String?, hourOfDay: Int, minute: Int) {
    ...
    private fun onDialogDateSet(tag: String?, year: Int, month: Int, dayOfMonth: Int) {
