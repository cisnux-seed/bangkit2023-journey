...
class NewsRepository private constructor(
    ...
    /**
     * Di sini terdapat komponen yang baru kita kenal bernama MediatorLiveData,
     * komponen ini digunakan jika Anda ingin menggabungkan banyak sumber data dalam sebuah LiveData.
     * */
    private val result = MediatorLiveData<Result<List<NewsEntity>>>()

    fun getHeadlineNews(): LiveData<Result<List<NewsEntity>>> {
        // Apabila data sumber bukan merupakan LiveData, gunakan fungsi setValue seperti berikut:
        ...
        // Namun, apabila data sumber berupa LiveData,
        // Anda perlu menggunakan fungsi addSource terlebih dahulu seperti ini:
