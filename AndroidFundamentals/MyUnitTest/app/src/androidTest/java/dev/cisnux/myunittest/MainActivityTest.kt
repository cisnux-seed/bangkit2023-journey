...
class MainActivityTest {
    ...
    fun assertGetCircumference() {
        onView(withId(R.id.edt_length))
            .perform(typeText(dummyLength), closeSoftKeyboard())
        onView(withId(R.id.edt_width))
            .perform(typeText(dummyWidth), closeSoftKeyboard())
        onView(withId(R.id.edt_height))
            .perform(typeText(dummyHeight), closeSoftKeyboard())
        ...
        onView(withId(R.id.btn_calculate_circumference))
            .check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculate_circumference))
            .perform(click())

        onView(withId(R.id.tv_results))
            .check(matches(isDisplayed()))
        onView(withId(R.id.tv_results))
    ...
    fun assertGetSurfaceArea() {
        ...
        onView(withId(R.id.btn_calculate_surface_area))
            .check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculate_surface_area))
            .perform(click())
        ...
        onView(withId(R.id.tv_results))
            .check(matches(isDisplayed()))
        onView(withId(R.id.tv_results))
            .check(matches(withText(dummySurfaceArea)))
    }
    ...
    fun assertGetVolume() {
        ...
        onView(withId(R.id.btn_calculate_volume))
            .check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculate_volume))
            .perform(click())
        ...
        onView(withId(R.id.tv_results))
            .check(matches(isDisplayed()))
        onView(withId(R.id.tv_results))
            .check(matches(withText(dummyVolume)))
    }
    ...
    fun assertEmptyInput() {
        ...
        onView(withId(R.id.edt_width))
            .perform(typeText(emptyInput), closeSoftKeyboard())
