...
import dev.cisnux.mynotesapprepository.databinding.ActivityNoteAddUpdateBinding
import dev.cisnux.mynotesapprepository.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private val viewModel: NoteAddUpdateViewModel by lazy {
        val factory = ViewModelFactory.getInstance(this.application)
        ViewModelProvider(this, factory)[NoteAddUpdateViewModel::class.java]
    }
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    if (isEdit) {
                        ...
                        note?.let { note ->
                            note.date = DateHelper.currentDate
                        }
